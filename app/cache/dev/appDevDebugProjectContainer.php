...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'symfony_db', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => 'Mohamed138', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->setNamespace('sf2orm_default_f4db1d2bcae9f8d4de75c4b97f91c6f5');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\wamp\\www\\symfony\\src\\Demo\\AlbumBundle\\Entity', 1 => 'C:\\wamp\\www\\symfony\\src\\Demo\\TaskBundle\\Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Demo\\AlbumBundle\\Entity');
        $f->addDriver($e, 'Demo\\TaskBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('AlbumBundle' => 'Demo\\AlbumBundle\\Entity', 'TaskBundle' => 'Demo\\TaskBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'fb910b10e2d76baef79eb8474956592e96');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\symfony\\src\\Demo\\AlbumBundle/Resources/views', 'Album');
        $instance->addPath('C:\\wamp\\www\\symfony\\src\\Demo\\PlaylistBundle/Resources/views', 'PlayList');
        $instance->addPath('C:\\wamp\\www\\symfony\\src\\Demo\\TaskBundle/Resources/views', 'Task');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fb910b10e2d76baef79eb8474956592e96');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AlbumBundle' => 'Demo\\AlbumBundle\\AlbumBundle',
                'PlayListBundle' => 'Demo\\PlaylistBundle\\PlayListBundle',
                'TaskBundle' => 'Demo\\TaskBundle\\TaskBundle',
            ...
            'database_user' => 'root',
            'database_password' => 'Mohamed138',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => 'fb910b10e2d76baef79eb8474956592e96',
            'database_path' => NULL,
            ...
            'kernel.secret' => 'fb910b10e2d76baef79eb8474956592e96',
            ...
            'assetic.ruby.bin' => 'C:\\Program Files\\RailsInstaller\\Ruby1.9.3\\bin\\ruby.EXE',
            'assetic.sass.bin' => 'C:\\Program Files\\RailsInstaller\\Ruby1.9.3\\bin\\sass.BAT',
